...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Flutrr, YieldS, DeductO, and DevP — AI-native SAP products built by SDC Consulting to drive pricing, deductions, and development outcomes." },
